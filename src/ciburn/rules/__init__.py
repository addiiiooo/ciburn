...
from ciburn.rules.history_rules import HISTORY_RULES
...
ALL_RULES: list[Rule] = [*STATIC_RULES, *HISTORY_RULES]

__all__ = ["ALL_RULES", "HISTORY_RULES", "STATIC_RULES", "Context", "Rule", "run_rules"]
